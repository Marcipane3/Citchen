...
export const DICT = {
  ...
  da: {
    ...
    assistant: {
      ...
      toolSuggest: "🍽 Hvad skal jeg lave?", toolLeftover: "🧺 Brug rester", toolGenerate: "✨ Find på en opskrift",
    ...
    capture: {
      ...
      lockedNote: "🔒 kræver din API-nøgle", keyOk: "🔑 API-nøgle til stede",
    ...
    lager: {
      ...
      scanAdd: "Tilføj til køleskabsliste", scanLocked: "🔒 Scan kræver din API-nøgle (Indstillinger).",
